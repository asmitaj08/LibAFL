...
ret_val = 0
exit_addr = 0x08001f14  # this will change depending on target
...
mach.ConfigurePeripheralsToReset(["cpu","nvic","flash_controller","timer2","timer4"])
...
# while True:
    # try:
        ...
        mach.sysbus.usart2.ReadFromFuzzer_PY(data)
