...
print("*********LoadElf********")
mach.load_elf("P2IM_Reflow_Oven.elf")
...
log_file_path = "log_gateway.log" # this gets saved in renode dir
trace_file_path = "trace_gateway" # this one in libafl_renode dir
