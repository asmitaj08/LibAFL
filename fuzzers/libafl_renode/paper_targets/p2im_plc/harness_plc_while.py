...
fault_addr1 = mach.sysbus.GetSymbolAddress("HAL_I2C_ErrorCallback")
print(f"HAL_I2C_ErrorCallback addr : {hex(fault_addr1)}")

fault_addr2 = mach.sysbus.GetSymbolAddress("HAL_UART_ErrorCallback")
print(f"HAL_UART_ErrorCallback addr : {hex(fault_addr2)}")

fault_addr3 = mach.sysbus.GetSymbolAddress("I2C_ITError")
print(f"I2C_ITError addr : {hex(fault_addr3)}")

fault_addr4 = mach.sysbus.GetSymbolAddress("UART_DMAAbortOnError")
print(f"UART_DMAAbortOnError addr : {hex(fault_addr4)}")
...
ret_val = 0
exit_addr = 0x0800464c  # this will change depending on target
...
mach.ConfigurePeripheralsToReset(["cpu","nvic","flash_controller"])
